...
(function(){
  var ref$, isType, map, filter, foldl, join, flatten, keys, empty, deepcopy, writeFile, build, isNonsense, exprValue, surveyFields, choicesFields, multilingualFields, pruneFalse, fieldnameConversion, typeConversion, choiceTypeConversion, dateTypeConversion, dateKindConversion, locationTypeConversion, metadataTypeConversion, appearanceConversion, newContext, genRange, convertQuestion, withColumn, genSettings, convertForm, serializeForm, writeForm;
